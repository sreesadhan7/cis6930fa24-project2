...
nlp = spacy.load("en_core_web_trf")  # Ensure this model is installed
...
def save_test_predictions(test_data, refined_predictions, submission_file):
    ...
    test_data["name"] = refined_predictions  # Add refined predictions to the test data
...
def main(train_file, test_file, submission_file):
    ...
    # Save refined predictions for the test set
